...
const chefs = document.querySelectorAll(".card-chef");
...
for (let chef of chefs) {
  chef.addEventListener("click", () => {
    const chefIndex = chef.getAttribute("id");
    window.location.href = `/chef/${chefIndex}`;
  });
}

// show or hide on recipe page
...
const PhotosUpload = {
  ...
  removePhoto(event){
    ...
    // get the children of the preview element
